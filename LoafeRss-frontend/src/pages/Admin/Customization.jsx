...
const Customization = () => {
    ...
    const fetchGroups = async () => {
        try {
            const res = await fetch('http://localhost:5001/api/store/customization-groups');
    ...
    const fetchGroupItems = async (groupId) => {
        try {
            const res = await fetch(`http://localhost:5001/api/store/customization-groups/${groupId}/items`);
    ...
    const handleDeleteGroup = async (id) => {
        ...
        try {
            const res = await fetch(`http://localhost:5001/api/store/customization-groups/${id}`, { method: 'DELETE' });
            if (res.ok) {
                fetchGroups();
    ...
    const handleItemSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`http://localhost:5001/api/store/customization-groups/${selectedGroup.id}/items`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleDeleteItem = async (itemId) => {
        ...
        try {
            await fetch(`http://localhost:5001/api/store/customization-items/${itemId}`, { method: 'DELETE' });
