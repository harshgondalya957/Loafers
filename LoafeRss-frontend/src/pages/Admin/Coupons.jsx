...
const Coupons = () => {
    ...
    const fetchCoupons = async () => {
        try {
            const res = await fetch('https://loafers-backend-2.onrender.com/api/store/coupons');
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const res = await fetch(`https://loafers-backend-2.onrender.com/api/store/coupons/${id}`, { method: 'DELETE' });
